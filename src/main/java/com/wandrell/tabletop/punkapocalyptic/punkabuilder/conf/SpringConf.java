...
public final class SpringConf {
    ...
    public static final String VIEW_ABOUT_DIALOG           = "aboutDialog";
    public static final String VIEW_FACTION_SELECTION_PANE = "factionSelectionPane";
    public static final String VIEW_GANG_CREATION_PANE     = "gangCreationPane";
